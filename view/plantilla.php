...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="assets/images/favicon.png" type="assets/images/png">
    ...
    <body>
        <!--================Header Area =================-->
        <?php
            require_once 'includes/header_cl.php';
        ?>
        <!--================Header Area =================-->
                ...
                <div class="row mb_30">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="assets/images/blog/blog-1.jpg" alt="post">
                            </div>
                            <div class="details">
                                <div class="tags">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="assets/images/blog/blog-2.jpg" alt="post">
                            </div>
                            <div class="details">
                                <div class="tags">
                                    <a href="#" class="button_hover tag_btn">Travel</a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="assets/images/blog/blog-3.jpg" alt="post">
                            </div>
                            <div class="details">
                                <div class="tags">
                                    <a href="#" class="button_hover tag_btn">Travel</a>
        ...
        <!--================ start footer Area  =================-->	
        <?php
            require_once 'includes/footer_cl.php';
        ?>
		<!--================ End footer Area  =================-->
